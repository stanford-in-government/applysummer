...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { application_id: @choice.application_id, organization_id: @choice.organization_id, rank: @choice.rank, statement: @choice.statement }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { application_id: @choice.application_id, organization_id: @choice.organization_id, rank: @choice.rank, statement: @choice.statement }
    assert_redirected_to choice_path(assigns(:choice))
  end
