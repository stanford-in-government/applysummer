...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { application_id: @recommendation.application_id, email: @recommendation.email, name: @recommendation.name, text: @recommendation.text }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { application_id: @recommendation.application_id, email: @recommendation.email, name: @recommendation.name, text: @recommendation.text }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
